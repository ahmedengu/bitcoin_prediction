...
if __name__ == '__main__':
    ...
    bt_market_info = bt_market_info[bt_market_info['Date'] >= datetime.strptime(start_date, '%Y%m%d')]
    bt_market_info = bt_market_info.reset_index()
    print("BT")
    ...
    # Feature Eng
    print("Feature ENG")
    bt_market_info.columns = ['bt_' + i for i in bt_market_info.columns]
    bt_market_info = bt_market_info.rename(
        columns={"bt_Date": "Date"})
    for coins in ['bt_']:
