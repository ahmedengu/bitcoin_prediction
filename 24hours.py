...
if __name__ == '__main__':
    ...
    norm_cols = [v for i, v in enumerate(model_data.columns) if
                 v not in ['Date', 'bt_day_diff', 'bt_close_off_high', 'bt_volatility',
                           'bt_MA_5', 'bt_EMA_5', 'bt_MOM_5', 'bt_ROC_5', 'bt_ATR_5',
                           'bt_BollingerB1_5', 'bt_BollingerB2_5', 'bt_PP', 'bt_R1', 'bt_S1',
                           'bt_R2', 'bt_S2', 'bt_R3', 'bt_S3', 'bt_SOK', 'bt_SOK_5', 'bt_SOD_5',
                           'bt_Trix_5', 'bt_ADX_5', 'bt_MACD_10_5', 'bt_MACDsign_10_5',
                           'bt_MACDdiff_10_5', 'bt_Mass_Index', 'bt_Vortex_5', 'bt_KST',
                           'bt_RSI_5', 'bt_TSI_10_5', 'bt_ICHIMOKU_SPAN1', 'bt_ICHIMOKU_SPAN2',
                           'bt_CHIKOU_SPAN', 'bt_PSAR', 'bt_ret_level1', 'bt_ret_level2',
                           'bt_ret_level3', 'bt_ext_level1', 'bt_ext_level2', 'bt_ext_level3']]
