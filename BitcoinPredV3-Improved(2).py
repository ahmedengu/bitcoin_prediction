...
bt_epochs = 200
bt_batch_size = 8
num_of_neurons_lv1 = 150
num_of_neurons_lv2 = 150
num_of_neurons_lv3 = 150
num_of_neurons_lv4 = 4
activ_func="tanh"
dropout=0.5
...
def ATR(df, n):  
    ...
    while i < df.index[-1]:  
        ...
        i = i + 1  
    TR_s = pd.Series(TR_l)  
    ATR = pd.Series(TR_s[::-1].ewm( span = n, min_periods = n).mean(),                    name = 'bt_ATR_' + str(n))[::-1]  
...
def PPSR(df):  
    ...
    psr = {'bt_PP':PP, 'bt_R1':R1, 'bt_S1':S1, 'bt_R2':R2,           'bt_S2':S2, 'bt_R3':R3, 'bt_S3':S3}  
...
def STOK(df):  
    SOk = pd.Series((df['bt_Close'] - df['bt_Low']) /                     (df['bt_High'] - df['bt_Low']), name = 'bt_SOK')  
...
model_data = bt_market_info[['Date'] + [coin + metric for coin in [ 'bt_']         for metric in ['Close',  'close_off_high', 'volatility', 'day_diff','High','Low','Open','Volume',                       'Market Cap','MA_5','EMA_5','MOM_5','ROC_5','ATR_5','BollingerB1_5','BollingerB2_5',                       'PP','R1','S1','R2','S2','R3','S3','SOK','SOK_5','SOD_5','Trix_5','ADX_5',                       'MACD_10_5','MACDsign_10_5','MACDdiff_10_5','Mass_Index','Vortex_5','KST'                        ,'RSI_5','TSI_10_5','ICHIMOKU_SPAN1','ICHIMOKU_SPAN2','CHIKOU_SPAN','PSAR']]]
#,'Volume','Market Cap'
...
norm_cols = [coin + metric for coin in ['bt_'] for metric in              ['Close', 'High', 'Low', 'Open','Volume','Market Cap',              'MA_5','EMA_5','MOM_5','ROC_5','ATR_5','BollingerB1_5','BollingerB2_5',              'PP','R1','S1','R2','S2','R3','S3','SOK','SOK_5','SOD_5','Trix_5','ADX_5',              'MACD_10_5','MACDsign_10_5','MACDdiff_10_5','Mass_Index','Vortex_5','KST'               ,'RSI_5','TSI_10_5','ICHIMOKU_SPAN1','ICHIMOKU_SPAN2','CHIKOU_SPAN','PSAR']]
#
...
reduce_lr  = ReduceLROnPlateau(monitor='val_loss', factor=0.9, patience=10,verbose = 1, mode = "auto",min_lr = 0.00001)
#tensorboard = TensorBoard(log_dir='./logs', histogram_freq=0, batch_size=16, write_graph=True, write_grads=False, write_images=False)
...
print('weights:')
# load weights
bt_model.load_weights("weights.hdf5")
...
book.save('Backtest_Output_85%Train_15%Test')
